...
function generateAccountId(legalName) {
...
async function runUpload(doc, onProgress) {
  const steps = 6;
...
export const onboardingApi = {
  ...
  async retryDocumentUpload(applicationId, documentId) {
    ...
    const resetDoc = { ...existing, status: 'uploading', uploadProgressPercent: 0, errorMessage: undefined };
    store.onboarding = {
      ...store.onboarding,
