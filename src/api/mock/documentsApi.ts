import type { OpsTradeDocumentApi, TradeDocumentApi, TradeDocumentType } from '../types/documents';
import { apiError, simulateNetwork } from './simulate';

const REQUIRED_TYPES: readonly TradeDocumentType[] = ['form_m', 'form_q', 'paar', 'bill_of_lading', 'commercial_invoice'];

export const tradeDocumentApi: TradeDocumentApi = {
...
export const opsTradeDocumentApi: OpsTradeDocumentApi = {
