...
interface BalanceCardProps {
  ...
  deltaText: string;
  deltaTone: Extract<StatusTone, 'success' | 'warning' | 'danger'>;
}

const DELTA_COLOR: Record<BalanceCardProps['deltaTone'], string> = {
  success: 'var(--color-success)',
  warning: 'var(--color-warning)',
  danger: 'var(--color-danger)',
};

export function BalanceCard({ currencyName, currency, balance, secondaryLine, deltaText, deltaTone }: BalanceCardProps) {
  return (
