  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border p-4 sm:p-6 shadow-xl" style={{ backgroundColor: 'var(--color-surface-1)', borderColor: 'var(--color-border-subtle)' }}>
        <div className="flex flex-wrap items-center justify-between gap-2 pb-4 border-b" style={{ borderColor: 'var(--color-border-subtle)' }}>
            ...
            >
              <div className="flex items-center gap-3.5 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-sm font-bold flex flex-wrap items-center gap-x-2 gap-y-0.5" style={{ color: 'var(--color-text-primary)' }}>
                    {doc.title}
        ...
        <div className="mt-6 rounded-xl border p-4 flex flex-col gap-2 text-xs text-neutral-400 sm:flex-row sm:items-center sm:justify-between" style={{ backgroundColor: 'var(--color-canvas)', borderColor: 'var(--color-border-subtle)' }}>
          <div className="flex items-center gap-2">
